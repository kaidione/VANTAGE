...
namespace FiddlerHelper
{
    ...
    public class LoopUtil
    {
        ...
        [DllImport("FirewallAPI.dll")]
        public static extern uint NetworkIsolationSetAppContainerConfig(uint pdwCntACs, SID_AND_ATTRIBUTES[] appContainerSids);
        ...
        public static List<SID_AND_ATTRIBUTES> PI_NetworkIsolationGetAppContainerConfig()
        {
        ...
        public static List<INET_FIREWALL_APP_CONTAINER> PI_NetworkIsolationEnumAppContainers()
        {
