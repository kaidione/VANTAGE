Feature: VAN14081_ProPluginLWSCompatibilityTest
	Test Case：https://jira.tc.lenovo.com/browse/VAN-14081
	Author：fengya2

@OldPluginLWSCompatibilityTest
Scenario: VAN14081_TestStep01_ProPluginOldShellNewWeb check UI
...
@OldPluginLWSCompatibilityTest
Scenario: VAN14081_TestStep10_ProdPluginNewShellOldWeb check UI
	When  Stop the IMC service in the task manager
	Given Waiting 1 seconds
	Given Delete LWS "Plugin Data"
	Given Delete LWS Registry
