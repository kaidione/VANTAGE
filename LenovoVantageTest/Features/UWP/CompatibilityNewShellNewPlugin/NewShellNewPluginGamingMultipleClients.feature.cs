...
namespace LenovoVantageTest.Features.UWP.CompatibilityNewShellNewPlugin
{
    ...
    [NUnit.Framework.DescriptionAttribute("NewShellNewPluginGamingMultipleClients")]
    public partial class NewShellNewPluginGamingMultipleClientsFeature
    {
...
#line 1 "NewShellNewPluginGamingMultipleClients.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/UWP/CompatibilityNewShellNewPlugin", "NewShellNewPluginGamingMultipleClients", "\tGaming Bamboo Agent 1 To Multiple Client", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.CategoryAttribute("NSNPGamingMultipleClientsSpecFlow")]
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 7
 testRunner.Given("Run Clients \'10.119.139.170\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
                        "\' Run Cat \'cat=X60NBGPUOCOff ||cat=MultiGameDetection ||cat=ThermalModeACModeX60" +
                        "AutoOff ||cat=X60NBGPUOCOffACToDC ||cat=X60NBGPUOCOffDCToAC ||cat=ThermalModeACM" +
                        "odeX60\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 17
 testRunner.Given("Run Clients \'10.119.171.47\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin\'" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 22
 testRunner.Given("Run Clients \'10.119.172.196\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 27
 testRunner.Given("Run Clients \'10.119.164.190\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 32
 testRunner.Given("Run Clients \'10.119.175.34\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin\'" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 37
 testRunner.Given("Run Clients \'10.119.169.187\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 42
 testRunner.Given("Run Clients \'10.119.188.123\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 47
 testRunner.Given("Run Clients \'10.119.177.64\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin\'" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 57
 testRunner.Given("Run Clients \'10.119.148.194\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 62
 testRunner.Given("Run Clients \'10.119.175.240\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 82
 testRunner.Given("Run Clients \'10.119.168.247\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
