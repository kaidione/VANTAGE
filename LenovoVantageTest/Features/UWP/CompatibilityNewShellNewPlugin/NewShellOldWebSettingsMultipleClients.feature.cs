...
namespace LenovoVantageTest.Features.UWP.CompatibilityNewShellNewPlugin
{
    ...
    [NUnit.Framework.DescriptionAttribute("NewShellNewPluginSettingsMultipleClients")]
    public partial class NewShellNewPluginSettingsMultipleClientsFeature
    {
...
#line 1 "NewShellOldWebSettingsMultipleClients.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/UWP/CompatibilityNewShellNewPlugin", "NewShellNewPluginSettingsMultipleClients", "\tSettings Bamboo Agent 1 To Multiple Client", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.CategoryAttribute("NSNPSettingsMultipleClientsSpecFlow")]
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 32
 testRunner.Given("Run Clients \'10.119.156.21\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin\'" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 37
 testRunner.Given("Run Clients \'10.119.132.209\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 42
 testRunner.Given("Run Clients \'10.119.152.53\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin\'" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 47
 testRunner.Given("Run Clients \'10.119.153.152\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 62
 testRunner.Given("Run Clients \'10.119.156.112\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 102
 testRunner.Given("Run Clients \'10.119.161.113\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 107
 testRunner.Given("Run Clients \'10.119.189.235\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 127
 testRunner.Given("Run Clients \'10.119.128.214\' And Run Version \'NewShellNewPlugin=NewShellNewPlugin" +
