Feature: NewShellNewPluginITSMultipleClients
	ITS Bamboo Agent 1 To Multiple Client

# http://10.119.149.105/index.html
@NSNPITSMultipleClientsSpecFlow
Scenario: Run NewShellNewPlugin ITS Local Run 1 Client DYTC4CQL
	Given Run Clients '10.119.149.105' And Run Version 'NewShellNewPlugin=NewShellNewPlugin' Run Cat 'cat=ThinkDytc4CQL || cat = DYTC4CQLSearch'

# http://10.119.154.73/index.html
@NSNPITSMultipleClientsSpecFlow
Scenario: Run NewShellNewPlugin ITS Local Run 2 Client DYTC4TIO
...
@NSNPITSMultipleClientsSpecFlow
Scenario: Run NewShellNewPlugin ITS Local Run 3 Client ITS2
...
@NSNPITSMultipleClientsSpecFlow
Scenario: Run NewShellNewPlugin ITS Local Run 4 Client DYTC6AMT
	Given Run Clients '10.119.159.53' And Run Version 'NewShellNewPlugin=NewShellNewPlugin' Run Cat 'cat=DYTC6AMTUI ||cat=DYTC6AMTActiveModeAndLink||cat=DYTC6AMTActiveModeAndLink_DC'

# http://10.119.181.181/index.html
@NSNPITSMultipleClientsSpecFlow
Scenario: Run NewShellNewPlugin ITS Local Run 5 Client DYTC3CQL
...
@NSNPITSMultipleClientsSpecFlow
Scenario: Run NewShellNewPlugin ITS Local Run 6 Client DYTC3TIO
...
#@NSNPITSMultipleClientsSpecFlow
#Scenario: Run NewShellNewPlugin ITS Local Run 7 Client ITS45
...
@NSNPITSMultipleClientsSpecFlow
Scenario: Run NewShellNewPlugin ITS Local Run 8 Client Agent-11
	Given Run Clients '10.119.145.190' And Run Version 'NewShellNewPlugin=NewShellNewPlugin' Run Cat 'cat=DYTC5ActiveStateUI||cat=DYTC5UI||cat=DYTC5toolbar'

# http://10.119.146.20/index.html
@NSNPITSMultipleClientsSpecFlow
Scenario: Run NewShellNewPlugin ITS Local Run 9 Client ITS5GPUOC
	Given Run Clients '10.119.146.20' And Run Version 'NewShellNewPlugin=NewShellNewPlugin' Run Cat 'cat=ideaITS5Function_17172S3S4 || cat=ITS5UI_17173 || cat=ITS5toolbar_20458 || cat=ITS5ToolbarUpdateTips || cat=ITS5Search'

# http://10.119.154.173/index.html
@NSNPITSMultipleClientsSpecFlow
Scenario: Run ITS Local Run 11 Client ITS agent-41
	Given Run Clients '10.119.154.173' And Run Version 'NewShellNewPlugin=NewShellNewPlugin' Run Cat 'cat=IntelligentCooling_18037 || cat=DYTC6MWSActiveStateUI || cat=IntelligentCooling_18037_offline || cat=ThinkDytc6CS2021S3S4_18037 || cat=CheckBatteryConditionOnThinkPad135W || cat =DYTC6MWSSearch'
