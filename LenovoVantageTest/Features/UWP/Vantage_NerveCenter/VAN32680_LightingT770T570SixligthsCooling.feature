@GetLightingFile
Feature: VAN32680_T7770T570SixligthsRear
	Test Case： https://lnvusjira.lenovonet.lenovo.local/browse/VAN-32680
	Author： Xuwei
	Test steps : 1-20

@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep01 check the page
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep02 check the Six lights name
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep03 check four lights name should be display
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 3
	When Set to default effect
	Then Click "3/6 Legion Liquid Cooling Pump Lighting" and Select "lightingType: Breath"
	Then Take Screen Shot 0301UI_check lighting subpage UI in 32680 under GamingScreenShotResult
	Then Lighting subpage profile 3 CPU default page is consisent with UI
	
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep04 check the page
	Given click the the customize
	Given Lighting page is opened
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep05 check the default profile
	When set lighting profile to default
	Given click the the customize
	Given Lighting page is opened
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep06 check the profile 1 Six lights default effect
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep07 check the profile 1 Six lights default brightness value
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 1
	When Set to default effect
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep08 check the profile 1 Six lights default speed value
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 1
	When Set to default effect
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep09 check the profile 1 color square
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 1
	When Set to default effect
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep10 check the profile 1 Six lights effect and color
	Given Need Compare File is 'true'
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 1
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep11 check the profile 2 Six lights default effect
	Given Need Compare File is 'true'
	Given click the the customize
	Given Lighting page is opened
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep12 check the profile 2 Six lights default brightness value
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 2
	When Set to default effect
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep13 check the profile 2 Six lights default speed value
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 2
	When Set to default effect
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep14 check the profile 2 color square
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 2
	When Set to default effect
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep15 check the profile 2 Six lights effect and color
	Given Need Compare File is 'true'
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 2
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep16 check the profile 3 Six lights default effect
	Given Need Compare File is 'true'
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 3
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep17 check the profile 3 Six lights default brightness value
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 3
	When Set to default effect
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep18 check the profile 3 Six lights default speed value
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 3
	When Set to default effect
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep19 check the profile 3 color square
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 3
	When Set to default effect
...
@LightingDTX70SixLightsCooling
Scenario:VAN32680_TestStep20 check the profile 3 Six lights effect and color
	Given Need Compare File is 'true'
	Given click the the customize
	Given Lighting page is opened
	Given select the profile 3
