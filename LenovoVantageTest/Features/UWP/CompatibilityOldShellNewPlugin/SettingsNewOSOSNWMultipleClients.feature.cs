...
namespace LenovoVantageTest.Features.UWP.CompatibilityOldShellNewPlugin
{
    ...
    [NUnit.Framework.DescriptionAttribute("SettingsNewOSOSNWMultipleClients")]
    public partial class SettingsNewOSOSNWMultipleClientsFeature
    {
...
#line 1 "SettingsNewOSOSNWMultipleClients.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/UWP/CompatibilityOldShellNewPlugin", "SettingsNewOSOSNWMultipleClients", "\tSettings Bamboo Agent 1 To Multiple Client", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.CategoryAttribute("SettingsNewOsOSNWMultiple")]
        public virtual void RunSettingsLocalRun1Client17()
        {
            string[] tagsOfScenario = new string[] {
                    "SettingsNewOsOSNWMultiple"};
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 37
    testRunner.Given("Run Clients \'10.119.161.51\' And Run Version \'OldShellNewPlugin=OldShellNewPlugin\'" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 47
    testRunner.Given("Run Clients \'10.119.172.55\' And Run Version \'OldShellNewPlugin=OldShellNewPlugin\'" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 52
 testRunner.Given("Run Clients \'10.119.181.161\' And Run Version \'OldShellNewPlugin=OldShellNewPlugin" +
