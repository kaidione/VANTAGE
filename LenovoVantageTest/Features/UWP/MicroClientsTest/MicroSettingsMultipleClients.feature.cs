...
namespace LenovoVantageTest.Features.UWP.MicroClientsTest
{
    ...
    [NUnit.Framework.DescriptionAttribute("MicroSettingsMultipleClients")]
    public partial class MicroSettingsMultipleClientsFeature
    {
...
#line 1 "MicroSettingsMultipleClients.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/UWP/MicroClientsTest", "MicroSettingsMultipleClients", "\tSettings Bamboo Agent 1 To Multiple Client", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.CategoryAttribute("MicroSettingsMultipleClientsSpecFlow")]
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 17
 testRunner.Given("Run Clients \'10.119.172.152\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=DaytimeAndECM || cat=HSToolbarThinkPad || cat=DaytimeAndECM-Hibe" +
                        "rnate || cat=CheckNoRemoveECM\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 32
 testRunner.Given("Run Clients \'10.119.156.21\' And Run Version \'VantageUWPType=MicroFrontendsVantage" +
                        "\' Run Cat \'cat!=OSLessDebug && cat=QuickSettingsOSLess || cat=QuickSettingsOSRes" +
                        "olution\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 37
 testRunner.Given("Run Clients \'10.119.132.209\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=SMBMicrophoneElevocAudio\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 42
 testRunner.Given("Run Clients \'10.119.152.53\' And Run Version \'VantageUWPType=MicroFrontendsVantage" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 47
 testRunner.Given("Run Clients \'10.119.153.152\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=keyboardbacklight3OptionsonIdeapad || cat=BatterySettingsTopPosi" +
                        "tionIdea || cat=TestSealedWarrnty \'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 57
 testRunner.Given("Run Clients \'10.119.175.44\' And Run Version \'VantageUWPType=MicroFrontendsVantage" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 62
 testRunner.Given("Run Clients \'10.119.176.160\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=HPDHardwareSettings || cat=BatterySettingsTopPositionThink || ca" +
                        "t=SmartBattery2.0NotSupport || cat=MicrophoneKeystroke || cat=CheckHiddenKeyboar" +
                        "dFunctions\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 77
 testRunner.Given("Run Clients \'10.119.177.130\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=SettingsSearchPowerPageGamingself\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 82
 testRunner.Given("Run Clients \'10.119.163.59\' And Run Version \'VantageUWPType=MicroFrontendsVantage" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 102
 testRunner.Given(@"Run Clients '10.119.182.162' And Run Version 'VantageUWPType=MicroFrontendsVantage' Run Cat 'cat=SettingsSearchSmartFlipToBootPowerPageGaming || cat=SmartBattery2.0GammingMachine || cat=ToolbarimageforNewWindows || cat=CheckCameraAndCameraPrivacygameming || cat=QuickSettingsOSInGamingMachine || cat=CheckCameraAndCameraPrivacygameming'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 107
 testRunner.Given("Run Clients \'10.119.141.87\' And Run Version \'VantageUWPType=MicroFrontendsVantage" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 112
 testRunner.Given("Run Clients \'10.119.165.117\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=SmartBattery2.0Manual \'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 127
 testRunner.Given("Run Clients \'10.119.128.214\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=BatteryChargeThresholdTwoBattery\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
