...
namespace LenovoVantageTest.Features.UWP.MicroClientsTest
{
    ...
    [NUnit.Framework.DescriptionAttribute("MicroSettingsNewOSMultipleClients")]
    public partial class MicroSettingsNewOSMultipleClientsFeature
    {
...
#line 1 "MicroSettingsNewOSMultipleClients.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/UWP/MicroClientsTest", "MicroSettingsNewOSMultipleClients", "\tSettings Bamboo Agent 1 To Multiple Client", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.CategoryAttribute("MicroNewOSSettingsMultipleClientsSpecFlow")]
...
#line 27
    testRunner.Given("Run Clients \'10.119.162.231\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=NOSToolbarPrivacyGuard || cat=CheckPrivacyGaurd\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 37
    testRunner.Given("Run Clients \'10.119.157.108\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=OSECourseToolbar || cat=IdeaPadNotSupportSwap18 || cat=CheckKeyb" +
                        "oardTopRowForIdeaPad\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 47
    testRunner.Given("Run Clients \'10.119.172.55\' And Run Version \'VantageUWPType=MicroFrontendsVantage" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 52
 testRunner.Given("Run Clients \'10.119.181.161\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=QuickSettingsCameraButton || cat=NewHSAForteMediaMicrophoneAudio" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 77
 testRunner.Given("Run Clients \'10.119.191.95\' And Run Version \'VantageUWPType=MicroFrontendsVantage" +
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 92
 testRunner.Given("Run Clients \'10.119.184.255\' And Run Version \'VantageUWPType=MicroFrontendsVantag" +
                        "e\' Run Cat \'cat=SmartBattery2.0\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 97
 testRunner.Given("Run Clients \'10.119.163.59\' And Run Version \'VantageUWPType=MicroFrontendsVantage" +
                        "\' Run Cat \'cat=ConservationModeBlacklist || cat=KeyboardCS20IdeaPad || cat=Check" +
                        "IdeaPadAlwaysOnUSBNoCheckbox\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
            this.ScenarioCleanup();
        }
