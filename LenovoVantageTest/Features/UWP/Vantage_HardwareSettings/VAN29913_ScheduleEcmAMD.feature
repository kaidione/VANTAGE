Feature: VAN29913_ScheduleEyeCareMode
	Test Case： https://jira.tc.lenovo.com/browse/VAN-29913
	Author： Daqi Fang
...
@EyeCareModeAMD
Scenario: VAN29913_TestStep23
	Given Go to Display & Camera page
	Given Click DisplayLink
	Given Click the ECM checkbox more times

@EyeCareModeAMD
Scenario: VAN29913_TestStep24
	Given Go to Display & Camera page
	Given Click DisplayLink
	Given "checked" the Eye care Mode checkbox
	When Cut page
