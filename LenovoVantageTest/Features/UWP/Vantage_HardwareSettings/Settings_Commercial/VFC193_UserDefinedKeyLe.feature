Feature: VFC193_UserDefinedKeyLe
	Test Case： https://jira.tc.lenovo.com/browse/VFC-193
	Author: DaQi Fang

@UserDefinedKeyLe
Scenario: VFC193_TestStep00_Init Environment
...
Scenario: VFC193_TestStep01_Check there is no userdefined feature under ThinkPad not support
Given Go to My Device Settings page
	When Click the InputPage Input Page Element
	When wait 10 seconds
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep03_Check the five option of this feature
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep04_Check the Select option will disapper
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep05_Select null of the option press F12 to launch Vantage or Privacy Guard
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep06_Check the Dropdown title after select the Open App and File
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep07_Check the defaule UI after select the Open App and File
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep08_Select any app or file press F12 to launch Vantage or Privacy Guard
Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep09_Check the application list for Standalone and Store App
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep10_Check the UI after user cancel to add app
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep11_Check the UI after user add an app
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep12_Check the UI after user add 6 app
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep13_Press F12 to invoke the 6 app
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep14_Delect one app and the ADD link can be clicked
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep15_Delete all the Added App
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep16_Add the Paint App twice
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
#@UserDefinedKeyLe
Scenario: VFC193_TestStep17_Add the Edge App and rename
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
#@UserDefinedKeyLe
Scenario: VFC193_TestStep19_Add the Edge App and rename
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep21_Cancel Add File and check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep22_Add one file and check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep23_Add 6 file and check the ADD link
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep24_Check all the six file is in opened state
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep25_Delete 1 file and check the ADD link
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep26_Delete All the added file and check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep27_Add a file twice and check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep28_Rename The file name
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep29_Remove The file name
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
#@UserDefinedKeyLe
Scenario: VFC193_TestStep30_Add a long file to UserDefinedKey
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep31_Delete file for UserDefinedKey
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep32_Create the file again for UserDefinedKey
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep33_Select Invoke Key Sequence check the Drop-down text
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep34_Select Invoke Key Sequence check the Note
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep35_Select Invoke Key Sequence check the text title
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep36_Select Invoke Key Sequence check the "5 keys at most"
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep38_Select Invoke Key Sequence press a key check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyle
Scenario: VFC193_TestStep39_Select Invoke Key Sequence press 6 key check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep40_Select Invoke Key Sequence press 6 key check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep41_Select Invoke Key Sequence press F12
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep42_Add Invoke Key Sequence check the add tip
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep43_Delete Invoke Key Sequence check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep45_Refresh Page and check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep46_ReLaunch Page and check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep47_Resize Page and check the UI
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep48_TestStep55_TestStep62_Check the default UI of Open website
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep50_Input a invalid URL of Open website
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep51_TestStep52_TestStep60_Check the default UI of Enter text
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep54_Input a invalid URL of Open website
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep63_Type a text and check help url hidden
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep64_Delete the URL in Open website check help text
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep65_TestStep57_TestStep58_TestStep49 Open the website user input
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStep65_TestStep59_TestStep53_TestStep61 Check Enter Text Apply tip and work well 
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
...
@UserDefinedKeyLe
Scenario: VFC193_TestStepZ_Delete all the settings for userDefinedKey
	Given Thinkpad machines
	And Machine support User defined key
	Given Go to My Device Settings page
	When Click the InputPage Input Page Element
