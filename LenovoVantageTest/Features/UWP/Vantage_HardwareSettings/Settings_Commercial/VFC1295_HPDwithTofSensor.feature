Feature: VFC1295_HPDwithTofSensor
	Test Case： https://jira.tc.lenovo.com/browse/VFC-1295
	Author: DaQi Fang

@HardwareSettingsHPDLe
Scenario: VFC1295_TestStep11 Check 'Go to Windows Hello Settings' link
...
@HardwareSettingsHPDLe
Scenario: VFC1295_TestStep29 set value and reinstall and check value
	Given Go to Smart Assist page
...
@HardwareSettingsHPDLe
Scenario: VFC1295_TestStep30 Check Zero Touch Lock text and take screen
	Given Go to Smart Assist page
	Given Check Zero Touch Lock switch button is on
	Given Scoll to HPD "ZTLock"
	Then Check Zero Touch Lock text
	Then Take Screen Shot 30CheckText in VFC1295 under HSScreenShotResult
	Given ClicK Zero Touch Lock ADSA SldierBar to "Near"
...
@HardwareSettingsHPDLe
Scenario: VFC1295_TestStep33 slider ADSA sliderbar and click reset
	Given Go to Smart Assist page
	Given Check Zero Touch Lock switch button is on
	Given Scoll to HPD "ResectButton"
	Given ClicK Zero Touch Lock ADSA SldierBar to "Far"
...
Scenario: VFC1295_TestStep51 no smart assist link
