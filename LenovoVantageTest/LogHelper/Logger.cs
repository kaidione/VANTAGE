namespace LenovoVantageTest.LogHelper
{
    ...
    public class Logger
    {
        ...
        public void WriteLog(string logContent, LogType logType = LogType.Information, string fileName = null, string basePath = @"C:\VantageTestLogs")
        {
            try
            {
                ...
                if (basePath.Equals(@"C:\VantageTestLogs"))
                {
